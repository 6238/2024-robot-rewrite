...
/**
 * This class is where almost all of the robot is defined - logic and subsystems are all set up here.
 */
public class RobotContainer {
  ...
  /**
   * This method is where all of the robot's logic is defined.
   * We link {@link edu.wpi.first.wpilibj2.command.button.Trigger}s, such as controller buttons and 
   * subsystem state, to {@link edu.wpi.first.wpilibj2.command.Command} instances.
   * The advantage of configuring all the robot's logic here is that it's easy to find, and therefore
   * easy to modify, what the robot does when something happens and why.
   */
